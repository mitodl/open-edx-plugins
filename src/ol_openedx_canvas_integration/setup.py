#!/usr/bin/env python
"""
Package metadata for ol_openedx_canvas_integration.
"""
import os
import re
import sys
...
VERSION = get_version('ol_openedx_canvas_integration', '__init__.py')
...
setup(
    ...
    version=VERSION,
    description="""Open edX plugin to add support for canvas integration""",
    long_description=README + '\n\n' + CHANGELOG,
    author='MIT Office of Digital Learning',
    url='https://github.com/mitodl/open-edx-plugins/ol_openedx_canvas_integration',
    packages=[
