...
from .helpers import HashableUser, MockSubsection, stub_canvas_client_factory
...
def test_push_edx_grades_to_canvas_pushes_existing_and_creates_new_assignments(
    ...
    course = SimpleNamespace(id="course-v1:MITx+course+2026", other_course_settings={})
    ...
    monkeypatch.setattr(api, "CanvasClient", stub_canvas_client_factory(stub_client))
    monkeypatch.setattr(
        api,
