...
VERSION = get_version('../ol_openedx_rapid_response_reports/ol_openedx_rapid_response_reports', '__init__.py')
...
#
# html_title = 'ol_openedx_rapid_response_reports v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'A plugin to add support for rapid response reports in Instructor Dashboard',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ol_openedx_rapid_response_reports'),
