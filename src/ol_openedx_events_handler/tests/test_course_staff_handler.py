...
from ol_openedx_events_handler.handlers.course_staff import (
...
TASK_PATCH = mock.patch(
    "ol_openedx_events_handler.tasks.course_staff"
...
def test_role_based_dispatch(
    ...
    with override_settings(ENROLLMENT_COURSE_STAFF_ROLES=allowed_roles):
        handle_course_access_role_added(
            sender=None,
