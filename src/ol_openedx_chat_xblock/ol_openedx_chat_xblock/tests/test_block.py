        ...
        test_cases = [
            {
                ...
                "base_url": "http://test.com/list/",
                "expected": "http://test.com/list/?run_readable_id=test_course_123%2Bcanvas",
            },
            {
            ...
            {
                "name": "fallback to learn_readable_course_id when course_id is empty",
                "course_id": "",
                "learn_readable_course_id": "canvas_course_123",
                "base_url": "http://test.com/list/",
                "expected": "http://test.com/list/?run_readable_id=canvas_course_123%2Bcanvas",
            },
            {
                "name": "course_id takes priority over learn_readable_course_id",
                "course_id": "priority_course_123",
                "learn_readable_course_id": "fallback_course_456",
                "base_url": "http://test.com/list/",
                "expected": "http://test.com/list/?run_readable_id=priority_course_123%2Bcanvas",
            },
        ]

        for case in test_cases:
            with self.subTest(case=case["name"]):
                self.xblock.course_id = case["course_id"]
                self.xblock.learn_readable_course_id = case["learn_readable_course_id"]

                with patch("ol_openedx_chat_xblock.block.settings") as mock_settings:
                    mock_settings.MIT_LEARN_AI_XBLOCK_PROBLEM_SET_LIST_URL = case[
                        "base_url"
                    ]
