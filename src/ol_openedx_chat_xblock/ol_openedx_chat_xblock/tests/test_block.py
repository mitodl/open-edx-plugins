...
class OLChatXBlockTest(ModuleStoreTestCase):
    ...
    def test_display_name_default(self):
        """Test that display_name has correct default value."""
        assert self.xblock.display_name == "OL Chat XBlock"

    def test_course_id_default(self):
        ...
        assert xblock.course_id == ""

    def test_is_tutor_xblock_default(self):
        """Test that is_tutor_xblock has correct default value."""
        xblock = OLChatXBlock(
            runtime=self.runtime,
            field_data=DictFieldData({}),
            scope_ids=self.scope_ids,
    ...
    def test_learn_readable_course_id_default(self):
        ...
        assert xblock.learn_readable_course_id == ""
    ...
    def test_render_template_no_context(self, mock_get_resource_bytes):
        ...
        result = render_template("test/template.html")
