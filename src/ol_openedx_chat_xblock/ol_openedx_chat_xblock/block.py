...
from ol_openedx_chat_xblock.constants import CANVAS_TUTOR_COURSE_ID_PREFIX
...
class OLChatXBlock(XBlock, StudioEditableXBlockMixin):
    ...
    def get_xblock_chat_url(self):
        """
        Generate the URL for the chat handler.
        """
        return (
    ...
    def get_ai_chat_js_args(self):
        ...
        init_payload = {
            ...
            "ask_tim_title": "About this Course",
            "bot_initial_message": "How can I help you today?",
        }

        if self.is_tutor_xblock:
            init_payload["ask_tim_title"] = "about course assignments"
            init_payload["problem_list_url"] = self.get_problem_set_url()
            init_payload["bot_initial_message"] = (
