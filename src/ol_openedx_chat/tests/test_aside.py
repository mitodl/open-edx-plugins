...
# aside-usage-v2:block-v1$:edX+DemoX+Demo_Course+type@video+block@b977ca990fd24471b2bb68a1041f3db6::ol_openedx_chat
@ddt
class OLChatAsideTests(RuntimeEnabledTestCase):
    ...
    def setUp(self):
        ...
        self.aside_usage_key = UsageKey.from_string(
            ...
            "@2582bbb68672426297e525b49a383eb8::ol_openedx_chat"
        )
        self.scope_ids = make_scope_ids(self.aside_usage_key)
        self.aside_instance = OLChatAside(
