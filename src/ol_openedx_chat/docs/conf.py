...
"""
ol-openedx-chat documentation build configuration file.
...
VERSION = get_version('../ol_openedx_chat', '__init__.py')
...
html_context = {
    ...
    "github_repo": 'ol-openedx-chat',  # Repo name
...
#
html_theme_options = {
    "repository_url": "https://github.com/MIT OL/ol-openedx-chat",
...
#
# html_title = 'ol-openedx-chat v0.1.0'
...
texinfo_documents = [
    (top_level_doc, project_title, documentation_title,
     author, project_title, 'MIT's AI chatbot for Open edX',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'ol_openedx_chat'),
                os.path.join(root_path, 'ol_openedx_chat/migrations')])
